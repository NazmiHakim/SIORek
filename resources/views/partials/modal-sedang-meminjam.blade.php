<form
    ...
    <div 
        @click="isSedangMeminjamModalOpen = false" 
        ...
        <div
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <span class="text-md font-semibold text-gray-800">Proyektor Epson EB-X41</span>
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <span class="text-md font-semibold text-gray-800">Senin, 25 Oktober 2025</span>
                            </div>
                            <div>
                                <span class="text-sm text-gray-500 block">Tanggal Selesai</span>
                                <span class="text-md font-semibold text-gray-800">Minggu, 2 November 2025</span>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="bg-blue-50 border rounded-lg border-blue-400 p-4 mt-4">
            ...
            <div class="p-6  rounded-b-lg flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3">
                <button @click="isSedangMeminjamModalOpen = false" type="button"  class="w-full flex-1 sm:w-auto mt-2 sm:mt-0 px-6 py-2 bg-white border border-black rounded-lg text-gray-700 font-medium hover:bg-gray-50">Batal</button>
