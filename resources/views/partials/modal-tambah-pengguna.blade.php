        ...
        <div class="max-h-[85vh] overflow-y-auto">
            ...
            <div class="p-6 space-y-4 border-b">
                ...
                <div>
                    ...
                    <input type="text" name="username" id="username" maxlength="50" placeholder="Masukkan username unik" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-500 focus:ring-blue-500" required value="{{ old('username') }}">
                </div>
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input id="logo" name="logo" type="file" accept=".jpg, .jpeg, .png" class="mt-1 block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                </div>
            </div> 
        </div> 
