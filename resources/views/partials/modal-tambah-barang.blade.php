    ...
    <form
        ...
        <div class="px-6 space-y-4">
            <div>
                ...
                <input type="text" name="nama_item" id="nama_barang" maxlength="100" placeholder="Masukkan nama barang" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
            </div>
