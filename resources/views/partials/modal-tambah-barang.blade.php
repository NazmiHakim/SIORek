        ...
        <div class="flex items-start justify-between p-6">
            ...
            <div class="px-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="file" name="foto_item" id="foto_item" accept="image/* "class="mt-1 block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                </div>
            </div>
            
            <div>
                <label for="kategori" class="block text-sm font-medium text-gray-700">Kategori</label>
                <input type="text" name="kategori" id="kategori" maxlength="50" placeholder="Contoh: Elektronik, Fotografi, dll" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            
            <div>
                <label for="jumlah_barang" class="block text-sm font-medium text-gray-700">Jumlah Barang</label>
                <input type="number" name="jumlah_total" id="jumlah_barang" value="1" min="1" max="10000" oninput="if(parseInt(this.value) > 10000) this.value = 10000;" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
            </div>
