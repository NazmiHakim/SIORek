        ...
        <div class="max-h-[85vh] overflow-y-auto" x-show="selectedUser">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input id="edit_logo" name="logo" type="file" class="mt-1 block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
