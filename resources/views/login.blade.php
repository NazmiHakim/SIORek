...
<body class="h-screen flex items-center justify-center bg-gradient-to-b from-gray-200 to-blue-500">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label for="username" class="block text-sm font-medium text-gray-700 mb-1">Nama Pengguna
            </label>
            ...
            <div>
                ...
                border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent bg-gray-50">
            </div>

            <button type="submit" class="w-full py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold 
            rounded-md transition">Login </button>
        </form>

        <p class="text-center text-sm text-gray-600 mt-5">Tidak Memiliki Akun?<span 
            class="text-gray-700 font-medium"><br>Hubungi Rektorat Untuk Pengajuan Akun</span></p>
    </div>
</body>
</html>
