...
<div class="bg-white p-6 rounded-lg shadow-lg" 
    ...
    <div class="flex justify-between items-center mb-6 ">
        ...
        <button @click="isTambahPenggunaModalOpen = true" class="inline-flex items-center justify-center 
        rounded-xl bg-biru-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-biru-tua 
        focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">Tambah</button>
    ...
    <div class="mt-8 grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-3">
        <section>
            ...
            @forelse ($himpunanUsers as $user)
                <div @click="selectedUser = {{ $user->toJson() }}; isDetailPenggunaModalOpen = true" 
                    class="border border-[#C6D2FF] bg-[#EEF2FF] rounded-lg p-3 mb-3 cursor-pointer 
